// frontend-react/src/components/teacher/SelectQuestionsModal.jsx
...
const SelectQuestionsModal = ({ show, handleClose, exam }) => {
    ...
    const fetchQuestions = useCallback(async () => {
        ...
        if (filterZorluk) {
            params.difficulty = filterZorluk;
        }
    ...
    }, [show, exam.questions, fetchQuestions]);
    ...
    return (
        <div className="modal-overlay" onClick={handleClose} tabIndex={-1} onKeyDown={(e) => { if (e.key === 'Escape') handleClose(); }}>
            <div 
                ...
                role="dialog"
                aria-modal="true"
                aria-labelledby="selectQuestionsModalTitle"
            >
                <h2 id="selectQuestionsModalTitle">{exam.title} Sınavına Soru Ekle/Çıkar</h2>
                ...
                <div className="filter-bar filter-modal-bar" style={{gridTemplateColumns: '1fr 1fr', alignItems: 'center'}}>
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', gap: '0.2rem'}}>
                        ...
                        <select 
                            value={filterZorluk} 
                            onChange={(e) => setFilterZorluk(e.target.value)} 
                            style={{maxWidth: '100%'}}
                        >

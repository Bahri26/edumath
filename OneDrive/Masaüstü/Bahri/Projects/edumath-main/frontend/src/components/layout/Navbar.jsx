                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-50 py-2 animate-fade-in">
                      <a href="#profile" className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl text-gray-700 dark:text-gray-200">
                        <UserCircle size={18} /> Profilim
                      </a>
                      <a href="#settings" className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl text-gray-700 dark:text-gray-200">
          ...
          <div className="pt-6 mt-4 border-t border-gray-100 dark:border-gray-800 flex flex-col gap-4">
            ...
            {user ? (
              <div className="flex flex-col gap-2 bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4">
                ...
                <a href="#profile" className="flex items-center gap-2 px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl text-gray-700 dark:text-gray-200">
                  <UserCircle size={18} /> Profilim
                </a>
                <a href="#settings" className="flex items-center gap-2 px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl text-gray-700 dark:text-gray-200">
                  <Settings size={18} /> Ayarlar
                </a>
                <button 
                  onClick={() => { 

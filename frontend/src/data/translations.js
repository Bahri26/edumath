export const translations = {
  tr: {
    ...
    about: {
      ...
      desc1: 'Matova, okul matematiğini ölçülebilir adımlara bölen dijital bir öğrenme ortamıdır. Öğrenci çalışır, öğretmen soru ve sınavları yönetir.',
    ...
    login: {
      ...
      registerSubtitle: 'Matova dünyasına katılmak için bilgilerinizi girin.',
      emailPlaceholder: 'ornek@matova.app',
      emailLoginPlaceholder: 'ornek@matova.app veya kullanıcı adı',
    ...
    footer: {
      desc: 'Matova; öğrenci, öğretmen ve araştırmacı için matematik öğrenme ve değerlendirme platformu.',
  ...
  en: {
    ...
    about: {
      ...
      desc1: 'Matova is a digital learning environment that breaks school math into measurable steps. Students practice; teachers manage questions and exams.',
    ...
    login: {
      ...
      registerSubtitle: 'Enter your details to join Matova.',
      emailPlaceholder: 'example@matova.app',
      emailLoginPlaceholder: 'example@matova.app or username',
    ...
    footer: {
      desc: 'Matova is a math learning and assessment platform for students, teachers, and researchers.',

export const getCurriculumData = (lang) => {
  const data = {
    tr: [
      ...
      {
        grade: 10,
        levelName: "Lise - Dizi Uygulamaları",
        title: "Dizilerde Analiz ve Modelleme",
        description: "Aritmetik ve geometrik örüntülerin sınav tipi problemler üzerinden incelenmesi.",
        topics: ["Geometrik artış ve azalış", "Dizilerde terim ilişkileri", "Gerçek hayat modelleme soruları"],
        outcomes: [
          "Geometrik ve aritmetik örüntüleri ayırt eder.",
          "Verilen kurala göre istenen terimi veya toplamı hesaplar.",
          "Sözel problemi uygun dizi modeliyle temsil eder."
        ],
        evaluation: "Yeni nesil soru çözümü, tablo yorumlama ve model kurma etkinlikleri."
      },
      {
        grade: 11,

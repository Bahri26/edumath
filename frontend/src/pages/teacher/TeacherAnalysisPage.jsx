                                ...
                                <div className="p-8 space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                            ...
                                            <div className="h-72">
                                                {studentDetails?.history?.length > 0 ? (
                                                    <ResponsiveContainer width="100%" height="100%">
                                                        <LineChart data={studentDetails.history}>
                                        ...
                                        <div className="bg-gradient-to-br from-white to-pink-50 border-2 border-pink-100 rounded-3xl p-6 shadow-lg">
                                            ...
                                            <div className="h-72">
                                                {studentDetails?.topics?.length > 0 ? (
                                                    <ResponsiveContainer width="100%" height="100%">
                                                        <BarChart data={studentDetails.topics.slice(0, 6)} layout="vertical">
                                                            ...
                                                            <Bar 
                                                                ...
                                                                barSize={24}
                                                            >
                                                                {studentDetails.topics.slice(0, 6).map((entry, index) => (
                                                                    <Cell 
                                                                        key={`cell-${index}`} 

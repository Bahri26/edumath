...
const NUMBER_COLOR_CLASSES = [
  'text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-900/20 border-indigo-100 dark:border-indigo-800/40',
  ...
  'text-violet-700 dark:text-violet-300 bg-violet-50 dark:bg-violet-900/20 border-violet-100 dark:border-violet-800/40',
];

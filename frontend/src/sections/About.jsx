          ...
          <FadeIn direction="left" delay={200}>
            <div className="space-y-8">
              ...
              <button
                ...
                className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-bold hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors group min-h-[44px]"
              >
                {t.about.btnStory}{' '}

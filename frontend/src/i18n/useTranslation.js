...
export function useProgressLabels() {
  ...
  return useMemo(
    () => ({
      ...
      exams: t('progress.exams'),
      noExams: t('progress.noExams'),
      examScore: t('progress.examScore'),
      summaryExams: t('progress.summaryExams'),
      avgExamHint: t('progress.avgExamHint'),
      examAnalysisTitle: t('progress.examAnalysisTitle'),
      examTrendTitle: t('progress.examTrendTitle'),
      chartScoreSplit: t('progress.chartScoreSplit'),
      chartDifficulty: t('progress.chartDifficulty'),
      chartTopics: t('progress.chartTopics'),
      chartQuestionTime: t('progress.chartQuestionTime'),
      weakTopics: t('progress.weakTopics'),
      questionDetails: t('progress.questionDetails'),
      answer: t('progress.answer'),
      language,
    }),
    [t, language],
  );
